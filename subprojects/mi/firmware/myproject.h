...
typedef emtf_hlslib::phase2::trk_invpt_t top_out_t;
constexpr int TOP_N_IN = emtf_hlslib::phase2::num_emtf_features;
constexpr int TOP_N_OUT = emtf_hlslib::phase2::num_emtf_predictions;
