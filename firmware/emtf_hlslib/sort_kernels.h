...
template <typename T>
void merge_eight_op(const T& a0, const T& a1, const T& a2, const T& a3, const T& b0, const T& b1, const T& b2,
                    const T& b3, T& r0, T& r1, T& r2, T& r3) {
  // hls-pragmas begin
#pragma HLS PIPELINE II = zonesorting_config::target_ii
#pragma HLS INTERFACE ap_ctrl_none port = return
...
template <typename T>
void max_of_seven_op(const T& a0, const T& a1, const T& a2, const T& a3, const T& a4, const T& a5, const T& a6,
                     T& out) {
  // hls-pragmas begin
